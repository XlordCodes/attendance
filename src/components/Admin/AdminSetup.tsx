      ...
      <div className="max-w-md w-full bg-white dark:bg-neutral-900 rounded-xl shadow-sm p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            ...
            <pre className="text-xs text-green-800 bg-green-50 p-2 rounded">
              {`{
  "name": "User Name",
  ...
  "createdAt": "timestamp"
          ...
          <div className="text-center space-y-2">
            <button
              ...
              className="w-full bg-black text-white px-6 py-2 rounded-lg hover:bg-gray-800 transition-colors inline-flex items-center justify-center space-x-2"
            >
