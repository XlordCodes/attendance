            ...
            <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-sm border border-gray-100 dark:border-neutral-800 border-gray-200 p-6">
              ...
              <div className="space-y-4">
                <button
                  ...
                  className="w-full bg-black text-white py-3 px-4 rounded-lg hover:bg-gray-800 flex items-center justify-center space-x-2"
                >
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 w-96">
            ...
            <div className="flex space-x-3 mt-4">
              <button
                ...
                className="flex-1 px-4 py-2 text-gray-700 dark:text-gray-300 bg-gray-100 hover:bg-gray-200 rounded-lg"
              >
                Cancel
              </button>
              <button
